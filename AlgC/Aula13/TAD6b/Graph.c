...
Graph* GraphFromFile(FILE* f) {
  // COMPLETAR !!
  //0 ou 1 -> grafo orientado
  //0 ou 1 -> arestas com pesos
  //num de vértices
  //num de arestas
  //vertice inicial -- vertice final -- peso(??)
  if((f = fopen("SWtinyDAG","r")) == NULL) return NULL;
...
unsigned short GraphCheckInvariants(const Graph* g) {
  // COMPLETAR !!
  //numEdges corresponde ao num total de nós da lista de arestas
  //mover to head para lista de vertices e ver número de nós em cada
  //outdegree -> numero de nós de arestas desse vertice
  //degree se grafo não orientado
