...
Graph* GraphCreate(unsigned short numVertices, unsigned short isDigraph, unsigned short isWeighted) {
...
Graph* GraphCreateComplete(unsigned short numVertices, unsigned short isDigraph) {
...
Graph* GraphCopy(const Graph* g) {
  ...
  Graph *toReturn = GraphCreate(numVertices, isDigraph, isWeighted);
  toReturn->isComplete = isComplete;
  toReturn->numEdges = numEdges;
  toReturn->verticesList = verticesList;
